...
OUTPUT_FEATURES_CSV = os.path.join(ROOT_DIR, "DB3_Categorized_features1.csv")  # Path for saving extracted features
...
for folder in input_folders:
    ...
    for file_name in os.listdir(input_folder):
        ...
        if os.path.isfile(file_path) and file_name.lower().endswith((".wav", ".m4a", ".mp3")):
            ...
            if features:
                features["label"] = folder  # Add label (e.g., subfolder name: 'dog', 'bear', etc.)
